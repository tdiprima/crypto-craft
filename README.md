...
Developers who need to encrypt data or verify integrity could reach for third-party libraries, or they might roll their own implementations using outdated approaches (MD5, SHA1 for passwords, ECB mode, static IVs). Sometimes the result is code that looks secure but isn't.
